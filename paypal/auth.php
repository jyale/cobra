...
define('AUTHORIZATION_ENDPOINT', 'https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize');
define('ACCESS_TOKEN_ENDPOINT', 'https://api.sandbox.paypal.com/v1/identity/openidconnect/tokenservice');

define('PROFILE_ENDPOINT', 'https://api.sandbox.paypal.com/v1/identity/openidconnect/userinfo/');

define('LOGOUT_ENDPOINT', 'https://api.sandbox.paypal.com/v1/identity/openidconnect/endsession');
define('VALIDATE_ENDPOINT', 'https://api.sandbox.paypal.com/v1/identity/openidconnect/checkid');

class PayPalAccess{
    private $key = 'AWaHKxBJNZU319-tusw1q8-nG7vk2xoLKJwSuM50-xfUVqNUFrcwu5q8Gc2V';
    private $secret = 'EMJpNRDI4oqA0ZmVogQVLdGAQVSmR07GS_qRbvuz1ERdn-gr37h3lbOpCxJE';
    private $scopes = 'openid profile'; //e.g. openid email profile https://uri.paypal.com/services/paypalattributes
    private $state;
    private $return_url = 'http://mahan.webfactional.com/paypal/return.php';
